...
urlpatterns = [
    ...
    path("apprentices/<int:pk>/", ApprenticeAPI.as_view(), name="apprenticesParameters"),
    path("apprentices/<str:idApprenticeEFK>/", ApprenticeAPI.as_view(), name="apprenticesParameters"),
    path("apprentices/<str:name>/", ApprenticeAPI.as_view(), name="apprenticesParameters"),
